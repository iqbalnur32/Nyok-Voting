...
<body>
  @if(Auth::guard('user')->user()->level_id === 1)
    <!-- Sidenav -->
      ...
      <div class="scrollbar-inner">
        ...
        <div class="navbar-inner">
          ...
          <div class="collapse navbar-collapse" id="sidenav-collapse-main">
            ...
            <ul class="navbar-nav">
              <li class="nav-item">
                <a class="nav-link {{ set_active('admin') }}" href="{{ route('admin') }}">
                  <i class="ni ni-tv-2 text-primary"></i>
                  <span class="nav-link-text">Dashboard Admin</span>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link {{ set_active('monitoring.data') }}" href="{{ route('monitoring.data') }}">
                  <i class="ni ni-sound-wave text-blue"></i>
                  <span class="nav-link-text">Monitoring Data</span>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link {{ set_active('master-category') }}" href="{{ route('master-category') }}">
                  <i class="ni ni-settings text-yellow dropdown-toggle"></i>
                  <span class="nav-link-text">Master Category Vote</span>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link {{ set_active('created-vote') }}" href="{{ route('created-vote') }}">
                  <i class="ni ni-archive-2 text-orange"></i>
                  <span class="nav-link-text">Management Create Vote</span>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link {{ set_active('management-jawaban.index')}}"  href="{{ route('management-jawaban.index') }}">
                  <i class="ni ni-archive-2 text-orange"></i>
                  <span class="nav-link-text">Management Jawaban Vote</span>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link {{ set_active('management-users.index')}}" href="{{ route('management-users.index') }}">
                      ...
                      <div class="row align-items-center">
                        ...
                        <div class="col ml--2">
                          <div class="d-flex justify-content-between align-items-center">
                            <div>
                              <h4 class="mb-0 text-sm">{{ Auth::guard('user')->user()->username }}</h4>
                            </div>
                ...
                <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <div class="media align-items-center">
                    ...
                    <div class="media-body  ml-2  d-none d-lg-block">
                      <span class="mb-0 text-sm  font-weight-bold">{{ Auth::guard('user')->user()->username }}</span>
                    </div>
                  </div>
                </a>
          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-lg-6">
              <div class="copyright text-center  text-lg-left  text-muted">
                &copy; <?php echo date('Y'); ?> <a href="https://www.creative-tim.com" class="font-weight-bold ml-1" target="_blank">Nyok Voting</a>
              </div>
            </div>
            <div class="col-lg-6">
              <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                <li class="nav-item">
                  <a href="https://www.creative-tim.com" class="nav-link" target="_blank">Nyok Voting</a>
                </li>
                <li class="nav-item">
