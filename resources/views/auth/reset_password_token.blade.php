...
<head>
  ...
  <title>Nyok Voting - Reset Password</title>
  <!-- Favicon -->
        ...
        <div class="col-lg-5 col-md-7">
          <div class="card bg-secondary border-0 mb-0">
            ...
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <form method="POST" action="{{ route('reset.password.token', $tokenData->token) }}" role="form">
                @csrf
                {{ method_field('PUT') }}
                ...
                <div class="form-group mb-3">
                  <div class="input-group input-group-merge input-group-alternative">
                    ...
                    <input class="form-control" placeholder="Password Lama" type="password" name="password_old">
                  </div>
                </div>
                <div class="form-group mb-3">
                  <div class="input-group input-group-merge input-group-alternative">
                    ...
                    <input class="form-control" placeholder="Password Baru" type="password" name="password_new">
                  </div>
                </div>
