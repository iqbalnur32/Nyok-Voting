  ...
  <nav id="navbar-main" class="navbar navbar-horizontal navbar-transparent navbar-main navbar-expand-lg navbar-light">
    <div class="container">
      <a class="navbar-brand" href="dashboard.html">
        <img src="{{url('template/assets/img/brand/white.png')}}">
      </a>
        ...
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a href="register.html" class="nav-link">
              <span class="nav-link-inner--text">Lupa Passsword</span>
            </a>
          </li>
        </ul>
        <hr class="d-lg-none" />
        ...
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-xl-5 col-lg-6 col-md-8 px-5">
              ...
              <p class="text-lead text-white">Silahkan Login Untuk Memulai Voting Kamu.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-lg-5 col-md-7">
          <div class="card bg-secondary border-0 mb-0">
            <div class="card-header bg-transparent pb-5">
              ...
              <div class="btn-wrapper text-center">
                <a href="#" class="btn btn-neutral btn-icon">
                  <span class="btn-inner--icon"><img src="{{url('template/assets/img/icons/common/github.svg') }}"></span>
                  <span class="btn-inner--text">Github</span>
                </a> 
                <a href="#" class="btn btn-neutral btn-icon">
                  <span class="btn-inner--icon"><img src="{{ url('template/assets/img/icons/common/google.svg') }}"></span>
            ...
            <div class="card-body px-lg-5 py-lg-5">
              ...
              @elseif(session('sukses_verify'))
                <div class="alert alert-primary alert-block">
                  <button type="button" class="close" data-dismiss="alert">×</button> 
                  <strong>{{ session('sukses_verify') }}</strong>
                </div>
                @elseif(session('gagal_verify'))
                <div class="alert alert-warning alert-block">
                  <button type="button" class="close" data-dismiss="alert">×</button> 
                  <strong>{{ session('gagal_verify') }}</strong>
                </div>
              @endif
      ...
      <div class="row align-items-center justify-content-xl-between">
        <div class="col-xl-6">
          <div class="copyright text-center text-xl-left text-muted">
            &copy; 2020 <a href="https://www.creative-tim.com" class="font-weight-bold ml-1" target="_blank">Nyok Voting</a>
          </div>
        </div>
        <div class="col-xl-6">
