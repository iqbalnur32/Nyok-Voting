        ...
        <div class="col-lg-5 col-md-7">
          <div class="card bg-secondary border-0 mb-0">
            <div class="card-header bg-transparent pb-5">
              <div class="text-muted text-center mt-2 mb-3"><h3>Reset Password</h3></div>
            </div>
            <div class="card-body px-lg-5 py-lg-5">
              ...
              @elseif(session('invalid_token'))
                <div class="alert alert-warning alert-block">
                  <button type="button" class="close" data-dismiss="alert">×</button> 
                  <strong>{{ session('invalid_token') }}</strong>
                </div>
              @endif
              ...
              <form method="POST" action="{{ route('reset.password') }}" role="form">
                ...
                <div class="text-center">
                  <button type="submit" class="btn btn-primary my-4 btn-block">Reset</button>
                </div>
              </form>
            </div>
          </div>
